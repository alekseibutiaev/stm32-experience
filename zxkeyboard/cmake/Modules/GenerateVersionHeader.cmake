...
#    set(${NAME}_VERSION ${HG_REVISION})
#  endif()
#endif()

# Generate a git-describe version string from Git repository tags
if(GIT_EXECUTABLE AND NOT DEFINED ${NAME}_VERSION)
  execute_process(
    COMMAND_ECHO ${GIT_EXECUTABLE} describe --tags --dirty --match "zxkeyboard_*"
    WORKING_DIRECTORY ${SRC_DIR}
  ...
  if(NOT GIT_DESCRIBE_ERROR_CODE)
    set(${NAME}_VERSION ${GIT_DESCRIBE_VERSION})
  endif()
endif()
...
if(NOT DEFINED ${NAME}_VERSION)
  set(${NAME}_VERSION v0.0.0-unknown)
  message(WARNING "Failed to determine ${NAME}_VERSION from repository tags. Using default version \"${${NAME}_VERSION}\".")
endif()
